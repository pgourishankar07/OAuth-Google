// __________________OAuth with Google________________
...
const GoogleStrategy = require("passport-google-oauth20").Strategy; //________untracked
const findOrCreate = require("mongoose-findorcreate"); //______________________untracked
...
userSchema.plugin(findOrCreate); //______________________untracked
...
passport.use(
  //______________________untracked
  new GoogleStrategy(
    {
...
app.post("/submit", (req, res) => {
  const submission = req.body.secret;
